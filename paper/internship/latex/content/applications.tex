...
\subsubsection[Vorhersage $x(n) \rightarrow x(n+50)$]{Vorhersage $\pmb{x(n) \rightarrow x(n+50)}$}
...
\begin{align}
MSE = \sum_n \left(x(n+50) - x'(n) \right)^2
\end{align}
...
\begin{figure}[H]
    ...
    \caption{Darstellung des Signals $x(n+50)$ und der Vorhersage $x'(n) \approx x(n+50)$.}
