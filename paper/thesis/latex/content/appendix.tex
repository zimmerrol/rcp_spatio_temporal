...
\begin{figure}[h]
	...
	\caption{Graphische Darstellung des normalisierten Fehlerwertes NRMSE für die drei verschiedenen Ansätze in Abhängigkeit von der Größe $a$ des vorherzusagenden Bereichs für das \textit{Mitchell-Schaeffer}-Modell.}
