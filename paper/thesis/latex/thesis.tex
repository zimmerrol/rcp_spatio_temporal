...
%% englische Titel.
\ThesisTitle{Vorhersage raumzeitlicher Dynamiken mittels Reservoir Computing}{Preidicting spatio-temporal dynamics using reservoir computing} % second brackets: english title
